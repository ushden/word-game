...
import { getRelevantLetters } from '../utils/letters';
...
const VirtualKeyboard: React.FC<VirtualKeyboardProps> = ({
                                                           ...
                                                           level,
                                                           discoveredLetters,
                                                           disabled = false // По умолчанию не заблокирована
                                                         }) => {
    ...
    <View style={[styles.keyboard, disabled && styles.keyboardDisabled]}>
      ...
      <View style={styles.keyboardGrid}>
        {relevantLetters.map(letter => {
          const isDiscovered = Object.values(discoveredLetters).includes(letter);
